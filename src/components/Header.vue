<template>
  <div class="header">
    ...
    <div class="notice-wrapper" v-on:click="showDetail">
      ...
      <div v-show="detailShow" class="detail">
        <div class="detail-wrapper clearfix">
          <div class="detail-main">
            ...
            <ul v-if="seller.supports" class="supports-all">
...
.notice-wrapper .icon-keyboard_arrow_right{
  position: absolute;
  font-size: 10px;
  right: 12px;
  top: 8px;
...
.special-wrapper .line{
  flex: 1;
  position: relative;
  top:-6px;
  border-bottom: 1px solid rgba(255,255,255,0.2)
}
.special-wrapper .text{
  margin: 0 12px;
  font-weight: 700;
  font-size: 14px;
}
...
.supports-all .support-item{
  padding: 0 12px;
  margin-bottom: 12px;
  font-size: 0;
}
.supports-all .support-item:last-child{
  margin-bottom:0;
}
.supports-all .support-item .icon{
  display: inline-block;
  width: 16px;
  height: 16px;
  vertical-align: top;
...
.supports-all .support-item .text{
  font-size: 12px;
  line-height: 16px;
}
.shop-notice{
